    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative text-white py-16 md:py-24">
        <div
          ...
          style={{
            backgroundImage:
              "url('/elderly-woman-laughing-with-caregiver-companion-in.jpg')",
          }}
        />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimateOnScroll animation="fade-up" delay={200}>
            <p className="text-xl text-white/80 max-w-3xl">
              Perfect for individuals who live alone, need emotional support or
              wish to stay socially active.
            </p>
          </AnimateOnScroll>
        </div>
      </section>
            ...
            <div>
              <AnimateOnScroll animation="fade-up">
                <h2 className="text-3xl font-bold text-foreground mb-6">
                  Meaningful Connection & Social Engagement
                </h2>
                <AnimateOnScroll animation="fade-up" delay={100}>
                  <p className="text-muted-foreground mb-6">
                    Loneliness can significantly impact health and wellbeing.
                    Our companionship care service provides genuine human
                    connection, conversation and social engagement to brighten
                    your day and keep you active.
                  </p>
                  <p className="text-muted-foreground mb-8">
                    Whether it's sharing a cup of tea, enjoying a walk in the
                    park, pursuing hobbies together, or simply having someone to
                    talk to, our friendly carers are here to provide the company
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Social engagement supports emotional wellbeing.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Knowing your loved one has regular company.
                      </p>
                    </div>
                  </div>
                </div>
