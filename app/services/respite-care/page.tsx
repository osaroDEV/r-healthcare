    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative text-white py-16 md:py-24">
        <div
          ...
          style={{ backgroundImage: "url('/family-caregiver-taking-break-while-professional-.jpg')" }}
        />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/80 max-w-3xl">
            A trusted break for families and unpaid carers. Flexible hours, days or short-term stays.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-3xl font-bold text-foreground mb-6">Taking a Break is Essential</h2>
              <p className="text-muted-foreground mb-6">
                Caring for a loved one is rewarding but can also be physically and emotionally demanding. Respite care
                gives family carers the opportunity to rest, recharge and attend to their own needs.
              </p>
              <p className="text-muted-foreground mb-8">
                Whether you need a few hours, a day, or longer-term support, our professional carers step in seamlessly
                to provide the same quality of care your loved one is accustomed to.
              </p>
            ...
            <div className="bg-muted/30 rounded-2xl p-8">
              <h3 className="text-xl font-bold text-foreground mb-6">Why Choose Respite Care?</h3>
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Prevent Carer Burnout</h4>
                    <p className="text-sm text-muted-foreground">Regular breaks help you maintain your own health.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">From a few hours to several days or weeks.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Seamless Transition</h4>
                    <p className="text-sm text-muted-foreground">We follow your care routines for consistency.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Complete Peace of Mind</h4>
                    <p className="text-sm text-muted-foreground">Know your loved one is in safe, caring hands.</p>
                  </div>
                </div>
              </div>
            </div>
