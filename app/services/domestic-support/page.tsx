    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative text-white py-16 md:py-24">
        <div
          ...
          style={{ backgroundImage: "url('/caregiver-helping-with-housework-in-bright-clean-h.jpg')" }}
        />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/80 max-w-3xl">
            Keeping your home clean, organised and comfortable so you can focus on what matters most.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-3xl font-bold text-foreground mb-6">A Clean, Comfortable Home Environment</h2>
              <p className="text-muted-foreground mb-6">
                Maintaining a clean and tidy home can become challenging as we age or when dealing with health
                conditions. Our domestic support services help keep your home comfortable, safe and welcoming.
              </p>
              <p className="text-muted-foreground mb-8">
                From light housework to laundry and shopping, our carers ensure your living environment supports your
            ...
            <div className="bg-muted/30 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Light Housework</h4>
                    <p className="text-sm text-muted-foreground">Vacuuming, dusting, tidying and general cleaning.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Laundry Services</h4>
                    <p className="text-sm text-muted-foreground">Washing, drying, ironing and putting away clothes.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Shopping Assistance</h4>
                    <p className="text-sm text-muted-foreground">Grocery shopping and collecting essentials.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Home Organisation</h4>
                    <p className="text-sm text-muted-foreground">Keeping your home safe and clutter-free.</p>
                  </div>
                </div>
              </div>
            </div>
