    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative text-white py-16 md:py-24">
        <div
          ...
          style={{ backgroundImage: "url('/caregiver-preparing-healthy-meal-for-elderly-perso.jpg')" }}
        />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/80 max-w-3xl">
            Ensuring proper nutrition and hydration with meals tailored to your preferences and dietary needs.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-3xl font-bold text-foreground mb-6">Nutritious Meals Prepared With Care</h2>
              <p className="text-muted-foreground mb-6">
                Good nutrition is essential for health and wellbeing. Our carers prepare fresh, delicious meals tailored
                to your tastes, dietary requirements and cultural preferences.
              </p>
              <p className="text-muted-foreground mb-8">
                We ensure you stay well-nourished and hydrated, making mealtimes an enjoyable part of your day rather
                than a challenge.
              </p>
            ...
            <div className="bg-muted/30 rounded-2xl p-8">
              <h3 className="text-xl font-bold text-foreground mb-6">Our Nutrition Support Includes</h3>
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Personalised Meal Planning</h4>
                    <p className="text-sm text-muted-foreground">Meals based on your preferences and health needs.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Dietary Requirements</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Cultural Preferences</h4>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Hydration Monitoring</h4>
                    <p className="text-sm text-muted-foreground">Ensuring adequate fluid intake throughout the day.</p>
                  </div>
                </div>
              </div>
            </div>
