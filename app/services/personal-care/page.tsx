...
export default function PersonalCarePage() {
  const items = ["Washing & bathing", "Dressing & grooming", "Toileting", "Continence support", "Oral hygiene"]
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative text-white py-16 md:py-24">
        <div
          ...
          style={{ backgroundImage: "url('/elderly-person-being-helped-with-personal-care-by-.jpg')" }}
        />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/80 max-w-3xl">
            Discreet, dignified assistance with daily personal care routines, always delivered with respect and privacy.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-3xl font-bold text-foreground mb-6">Supporting Your Daily Personal Care Needs</h2>
              <p className="text-muted-foreground mb-6">
                At Ritzy Healthcare, we understand that personal care is deeply private. Our trained carers provide
                sensitive, professional support with daily hygiene and grooming routines, helping you maintain your
                dignity and independence.
              </p>
              <p className="text-muted-foreground mb-8">
                Every aspect of personal care is delivered with the utmost respect, ensuring you feel comfortable and
                valued throughout. We work at your pace and adapt to your preferences.
              </p>
            ...
            <div className="bg-muted/30 rounded-2xl p-8">
              <h3 className="text-xl font-bold text-foreground mb-6">Why Choose Us for Personal Care?</h3>
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Trained, Vetted Carers</h4>
                    <p className="text-sm text-muted-foreground">
                      All carers are DBS-checked and specially trained in personal care.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Same Carer Consistency</h4>
                    <p className="text-sm text-muted-foreground">
                      We match you with consistent carers to build trust and familiarity.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Dignity & Respect</h4>
                    <p className="text-sm text-muted-foreground">
                      Privacy and dignity are at the heart of everything we do.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Care visits arranged around your preferred times and routines.
                    </p>
                  </div>
                </div>
              </div>
