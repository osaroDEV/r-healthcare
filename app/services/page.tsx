...
const services = [
  ...
  },
  {
    ...
    description:
      "Ensuring proper nutrition and hydration with meals tailored to your preferences and needs.",
    icon: "🍽️",
    items: [
  ...
  },
  {
    ...
    description:
      "Keeping your home clean, organised and comfortable so you can focus on what matters.",
    icon: "🏠",
...
const processSteps = [
  {
    ...
    description: "Free and friendly discussion to understand your needs",
  },
  {
    step: "2",
    title: "Comprehensive Care Assessment",
    description: "Detailed evaluation of care requirements",
  },
  {
    step: "3",
    title: "A Tailored Care Plan",
    description: "Personalised plan designed around your needs",
  },
  {
    step: "4",
    title: "Care Commences",
    description: "Your matched carer begins providing support",
  },
  {
    step: "5",
